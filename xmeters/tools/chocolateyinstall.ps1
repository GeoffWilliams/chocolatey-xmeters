...
$url        = 'https://entropy6.com/xmeters/downloads/XMetersSetup.exe' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  # MSI
  silentArgs    = "/quiet /install /norestart" # ALLUSERS=1 DISABLEDESKTOPSHORTCUT=1 ADDDESKTOPICON=0 ADDSTARTMENU=0
